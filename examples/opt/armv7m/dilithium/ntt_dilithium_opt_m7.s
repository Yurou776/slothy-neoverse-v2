...
pqcrystals_dilithium_ntt_opt_m7:
  ...
  1:
    ...
    add cntr, ptr_p, #1024 // 64 iterations
        ...
        add r14, r7, r5                  // ........*.....................
        add r12, r8, r9                  // .........*....................
        sub.w r7, r12, r9, lsl #1        // ..........*...................
        smull r8, r9, r12, r6            // ..........*...................
        smull r6, r11, r7, r10           // ...........*..................
        sub.w r7, r14, r5, lsl #1        // ............*.................
        mul r12, r8, r2                  // ............*.................
        mul r10, r6, r2                  // .............*................
...
layer78_loop:
        ...
        ldr.w r14, [r0, #8]               // ......e.......................
        ldr.w r9, [r0, #4]                // .......e......................
        smlal r8, r11, r7, r3             // .......e......................
        ldr r7, [r1, #-4]                 // ........e.....................
        smull r14, r12, r14, r10          // ........e.....................
        str r6, [r0, #-4]                 // .........*....................
        add r9, r9, r11                   // .........e....................
        sub.w r11, r9, r11, lsl #1        // ..........e...................
        mul r10, r14, r2                  // ..........e...................
        ldr r8, [r1, #-8]                 // ...........e..................
        smull r6, r11, r11, r7            // ...........e..................
        ldr.w r7, [r0]                    // ............e.................
        smlal r14, r12, r10, r3           // ............e.................
        smull r8, r9, r9, r8              // .............e................
        add r14, r7, r12                  // ..............e...............
        mul r10, r6, r2                   // ..............e...............
        sub.w r7, r14, r12, lsl #1        // ...............e..............
        mul r12, r8, r2                   // ...............e..............
        str r5, [r0, #-12]                // ................*.............
        ...
        smlal r6, r11, r10, r3            // .*............................
        add r10, r14, r9                  // ..*...........................
        str r10, [r0], #16                // ..*........................... // @slothy:core // @slothy:before=cmp
        sub.w r10, r10, r9, lsl #1        // ...*..........................
        str r10, [r0, #-12]               // ...*..........................
        add r7, r7, r11                   // ....*.........................
        cmp.w r0, r4                      // ....*......................... // @slothy:id=cmp
